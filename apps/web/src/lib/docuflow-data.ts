...
export const documents: DocumentRecord[] = [
  {
    documentId: "doc-001",
    originalFileName: "invoice-aws-amplify-june.pdf",
    ...
    userId: "user-123",
    rawS3Key: "raw/user-123/doc-001/original.pdf",
    processedS3Key: "processed/user-123/doc-001/result.json",
    reviewReasonCodes: [],
    lineItems: [
      {
        lineItemId: "item-1",
  ...
  {
    documentId: "doc-002",
    originalFileName: "receipt-office-supplies.jpg",
    ...
    userId: "user-123",
    rawS3Key: "raw/user-123/doc-002/original.jpg",
    processedS3Key: "processed/user-123/doc-002/result.json",
    reviewReasonCodes: ["taxAmount missing", "currency confidence is low"],
    lineItems: [
      {
        lineItemId: "item-1",
        description: "Office paper and folders",
        quantity: 4,
        unitPriceAmount: 140000,
        taxAmount: 0,
        totalAmount: 560000,
        confidenceScore: 0.8,
      },
  ...
  {
    documentId: "doc-003",
    originalFileName: "invoice-saas-license.pdf",
    documentType: "INVOICE",
    status: "PROCESSING",
    reviewStatus: "NOT_REQUIRED",
    ...
    userId: "user-123",
    rawS3Key: "raw/user-123/doc-003/original.pdf",
    processedS3Key: "processed/user-123/doc-003/result.json",
    reviewReasonCodes: [],
    lineItems: [
      {
        lineItemId: "item-1",
  ...
  {
    documentId: "doc-004",
    originalFileName: "blurry-travel-receipt.png",
    documentType: "RECEIPT",
    status: "FAILED",
    reviewStatus: "NOT_REQUIRED",
    vendorName: "Unknown",
    ...
    userId: "user-456",
    rawS3Key: "raw/user-456/doc-004/original.png",
    processedS3Key: "processed/user-456/doc-004/error.json",
    reviewReasonCodes: ["vendorName missing", "totalAmount missing", "currency missing"],
    lineItems: [],
  ...
  {
    documentId: "doc-005",
    originalFileName: "invoice-cleaning-service.pdf",
    documentType: "INVOICE",
    status: "APPROVED",
    ...
    userId: "user-456",
    rawS3Key: "raw/user-456/doc-005/original.pdf",
    processedS3Key: "processed/user-456/doc-005/result.json",
    reviewReasonCodes: [],
    lineItems: [
      {
        lineItemId: "item-1",
  ...
  {
    documentId: "doc-006",
    originalFileName: "invoice-catering-june.pdf",
    documentType: "INVOICE",
    status: "QUEUED",
    reviewStatus: "NOT_REQUIRED",
    ...
    userId: "user-123",
    rawS3Key: "raw/user-123/doc-006/original.pdf",
    processedS3Key: "processed/user-123/doc-006/result.json",
    reviewReasonCodes: [],
    lineItems: [],
  ...
  {
    documentId: "doc-007",
    originalFileName: "receipt-parking-corrected.jpg",
    documentType: "RECEIPT",
    status: "CORRECTED",
    ...
    userId: "user-456",
    rawS3Key: "raw/user-456/doc-007/original.jpg",
    processedS3Key: "processed/user-456/doc-007/result.json",
    reviewReasonCodes: ["taxAmount missing"],
    lineItems: [],
