            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Choose which workflow notifications should arrive by email.
                  </CardDescription>
                </CardHeader>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-3">
                          ...
                          <div className="space-y-1">
                            <FormLabel>Processing status updates</FormLabel>
                            <p className="text-sm text-muted-foreground">
                              Receive status changes for uploaded invoice and receipt files.
                            </p>
                          </div>
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-3">
                          ...
                          <div className="space-y-1">
                            <FormLabel>Cost and budget alerts</FormLabel>
                            <p className="text-sm text-muted-foreground">
                              Receive AWS Budgets threshold and monthly cost visibility alerts.
                            </p>
                          </div>
                        </FormItem>
                      )}
              ...
              <CardContent>
                <div className="space-y-6">
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-medium">Document status updates</TableCell>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">Budget alerts</TableCell>
                        <TableCell className="text-center">
                          <FormField
                            control={form.control}
